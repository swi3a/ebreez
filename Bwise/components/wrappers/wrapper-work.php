                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <form action="#">
                                <div class="card-body">
                                    <h4 class="card-title">Informations sur le travaile</h4>
                                </div>
                                <hr>
                                <div class="form-body">
                                    <div class="card-body">
                                        <div class="row pt-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Nom de travaile</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group ">
                                                    ...
                                                    <select class="form-control form-select">
                                                        <option value=""></option>
                                                        <option value="">sariya</option>
                                                        <option value="">7ayte</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="hauteur" class="form-control" placeholder=".....">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" id="largeur" class="form-control " placeholder="....">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group ">
                                                    <label class="form-label">Profondeur</label>
                                                    <input type="text" id="profondeur" class="form-control " placeholder="....">
                                                </div>
                                            </div>
                                        </div>
                                    </div>

            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo text --><span>
                         <!-- dark Logo text -->
                         <img src="../assets/images/Bwise2.png" alt="homepage" class="dark-logo" id="Logo" />
                         <!-- Light Logo text -->    
                         <img src="../assets/images/Bwise.png" class="light-logo" alt="homepage" /></span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="../assets/images/users/5.jpg" class="img-circle" width="150" />
                                    <h4 class="card-title m-t-10">L3arbi 9assem</h4>
                                    <h6 class="card-subtitle">9awad swa3da b7al khalil</h6>
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                <h6>l3arbi@gmail.com</h6> <small class="text-muted p-t-30 db">Phone</small>
                                <h6>+91 654 784 547</h6> <small class="text-muted p-t-30 db">Address</small>
                                <h6>71 zen9t l97ab</h6>
                                <div class="map-box">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab" href="#home" role="tab">Ligne du temps</a> </li>
